...
> comando, antes de carregá-los no R. Entendendo o banco de dados bem serÃ¡ Ãºtil quando
> formos fazer decisÃµes sobre como carregá-lo no R. Use a linha de comando shell para
...
> ## Dica: Versão para saída descartÃ¡vel
>
> Geralmente você nÃ£o deseja criar uma versÃ£o para saída descartável (ou dados para
